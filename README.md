...
```
transformer, sentence_transformers 디렉토리를 .KoSBERT/lib/python3.7/site-packages/ 로 이동합니다. <br>
...
|:------------------------:|:----:|:----:|:----:|:----:|:----:|:----:|:----:|:----:|
|NLl|71.13|73.97|72.85|73.08|72.92|73.07|68.96|68.77|
|STS|80.75|80.39|79.03|78.81|78.97|78.76|73.04|73.65|
...
두 남자가 수레를 숲 솦으로 밀었다. (Score: 0.1792)
...
두 남자가 수레를 숲 솦으로 밀었다. (Score: 0.1037)
...
두 남자가 수레를 숲 솦으로 밀었다. (Score: 0.3216)
...
결과는 다음과 같습니다 :
 ```
 Cluster  1
['두 남자가 수레를 숲 솦으로 밀었다.', '치타 한 마리가 먹이 뒤에서 달리고 있다.', '치타가 들판을 가로 질러 먹이를 쫓는다.']
